<!DOCTYPE html>
	<html lang="en">
	<head>
	  <meta name="description" content="CSS border-right-style Property">
	  <meta name="keywords" content="css,css3,CSS border-right-style Property">
	  <meta name="author" content="webschooltoday.com">
    <title>CSS border-right-style Property - WebSchool Today</title>
 <?php include "../links.php" ?></head>
<body>
<div>
<div class="tital">CSS border-right-style Property</div>    
...
<?php include "info_css_inner.php" ?>
        <div class="rg3-sec_main">
            <div class="rg3-sec_u">
                ...
                <h1>CSS <code>border-right-style</code> Property</h1>
                <p class="topic">Topic: <a href="stylel_properties.php">CSS3 Properties Reference</a><span class="topic-nav"><a href="style_border-right-color-property.php"><i class="fa fa-arrow-left" aria-hidden="true"></i></a><a href="style_border-right-width-property.php"><i class="fa fa-arrow-right" aria-hidden="true"></i></a></span></p>
                <h2>Description</h2>
                <p>The <code>border-right-style</code> CSS property sets the style of an element's right border individually. However in many cases the shorthand CSS properties like <code><a href="style_border-style-property.php">border-style</a></code> or <code><a href="style_border-right-property.php">border-right</a></code> are more convenient to use and preferable.</p>
                ...
                <div class="shadow">
                    <div class="syntax">
                        <table>
                            <tr>
                                <td><pre class="property">border-right-style: </pre></td>
                ...
                <p>The example below shows the <code>border-right-style</code> property in action.</p>
                <div class="example">
                    <div class="my_codeb">
                        <div class="my_codeb-title"><h4>Example</h4><a href="../codelab07cf.html" target="_blank" class="try-btn" title="Try this code using online Editor">Try this code <span>&raquo;</span></a></div>
                        <textarea id="code1">
    ...
    border-right-width: 3px;
                ...
                <div class="shadow space">
                    <table class="data">
                        ...
                        <tr>
                            ...
                            <td>If specified, the associated element takes the <a href="../definitions.php#computed-value">computed value</a> of its parent element <code>border-right-style</code> property.</td>
                        </tr>
                    </table>
                </div>
                <hr />
                <h2>Browser Compatibility</h2>
                <p>The <code>border-right-style</code> property is supported in all major modern browsers.</p>
                <div class="shadow">
                    <div class="support">
                        <table>
                            <tr>
                ...
                <div class="bottom-link clearfix">
                    <a href="style_border-right-color-property.php" class="previous-page-bottom"><i class="fa fa-arrow-left" aria-hidden="true"></i> Previous</a>
                    <a href="style_border-right-width-property.php" class="next-page-bottom" style="float:right;">Next <i class="fa fa-arrow-right" aria-hidden="true"></i></a>
                    </div>
            </div>
        </div>        
        <div class="sidebar">
