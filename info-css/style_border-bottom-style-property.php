<!DOCTYPE html>
	<html lang="en">
	<head>
	  <meta name="description" content="CSS border-bottom-style Property">
	  <meta name="keywords" content="css,css3,CSS border-bottom-style Property">
	  <meta name="author" content="webschooltoday.com">
    <title>CSS border-bottom-style Property - WebSchool Today</title>
...
<?php include "info_css_inner.php" ?>
        <div class="rg3-sec_main">
            <div class="rg3-sec_u">
                ...
                <h1>CSS <code>border-bottom-style</code> Property</h1>
                <p class="topic">Topic: <a href="stylel_properties.php">CSS3 Properties Reference</a><span class="topic-nav"><a href="stylel_border-bottom-right-radius-property.php"><i class="fa fa-arrow-left" aria-hidden="true"></i></a><a href="style_border-bottom-width-property.php"><i class="fa fa-arrow-right" aria-hidden="true"></i></a></span></p>
                <h2>Description</h2>
                <p>The <code>border-bottom-style</code> CSS property sets the style of an element's bottom border individually. However in many cases the shorthand CSS properties like <code><a href="style_border-style-property.php">border-style</a></code> or <code><a href="style_border-bottom-property.php">border-bottom</a></code> are more convenient to use and preferable.</p>
                ...
                <div class="shadow">
                    <div class="syntax">
                        <table>
                            <tr>
                                <td><pre class="property">border-bottom-style: </pre></td>
                ...
                <p>The example below shows the <code>border-bottom-style</code> property in action.</p>
                <div class="example">
                    <div class="my_codeb">
                        <div class="my_codeb-title"><h4>Example</h4><a href="../codelab17b3.html" target="_blank" class="try-btn" title="Try this code using online Editor">Try this code <span>&raquo;</span></a></div>
                        <textarea id="code1">
    ...
    border-bottom-width: 3px;
                ...
                <div class="shadow space">
                    <table class="data">
                        ...
                        <tr>
                            ...
                            <td>If specified, the associated element takes the <a href="../definitions.php#computed-value">computed value</a> of its parent element <code>border-bottom-style</code> property.</td>
                        </tr>
                    </table>
                </div>
                <hr />
                <h2>Browser Compatibility</h2>
                <p>The <code>border-bottom-style</code> property is supported in all major modern browsers.</p>
                <div class="shadow">
                    <div class="support">
                        <table>
                            <tr>
                ...
                <div class="color-box">
                    <div class="shadow">
                        ...
                        <div class="warning-box">
                            <p><strong>Warning:</strong> Internet Explorer 7 and earlier versions don't support the value <code>hidden</code>. IE8 supports, but requires a <code><a href="../html-tutorial/html-doctypes.php">&lt;!DOCTYPE&gt;</a></code>. IE9 and above supports the <code>hidden</code> value.</p>
                        </div>
                    </div>
                </div>
                <hr />
                ...
                <div class="bottom-link clearfix">
                    <a href="stylel_border-bottom-right-radius-property.php" class="previous-page-bottom"><i class="fa fa-arrow-left" aria-hidden="true"></i> Previous</a>
                    <a href="style_border-bottom-width-property.php" class="next-page-bottom" style="float:right;">Next <i class="fa fa-arrow-right" aria-hidden="true"></i></a>
                    </div>
            </div>
        </div>        
        <div class="sidebar">
