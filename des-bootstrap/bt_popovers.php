<!DOCTYPE html>
	<html lang="en">
	<head>
	<meta name="description" content="How to Create Popovers with Bootstrap 4">
	  <meta name="keywords" content="Bootstrap,Bootstrap4,How to Create Popovers with Bootstrap 4,popvers">
	  <meta name="author" content="webschooltoday.com">
    <title>How to Create Popovers with Bootstrap 4 - WebSchool Today</title>
    <?php include "../links.php" ?>
</head>
<body>
<div>
<div class="tital">How to Create Popovers with Bootstrap 4</div>    
        ...
        <div class="rg3-sec_main">
            <div class="rg3-sec_u">
             ...
             <a href="bt_alerts.php" class="next-page" title="Go to Next Page"><i class="fa fa-arrow-right" aria-hidden="true"></i>
                ...
                <p>Popovers can be triggered via JavaScript &mdash; just call the <code>popover()</code> Bootstrap method with the <code>id</code>, <code>class</code> or any <a href="../des-css/style_selectors.php">CSS selector</a> of the required element in your JavaScript code.</p>
                <div class="example">
                    <div class="my_codeb">
                        <div class="my_codeb-title"><h4>Example</h4><a href="../codelab7010.html" target="_blank" class="try-btn" title="Try this code using online Editor">Try this code <span>&raquo;</span></a></div>
                        <textarea id="code1" >
<script>
$(document).ready(function(){
    $('[data-toggle="popover"]').popover();   
                ...
                <div class="example">
                    <div class="my_codeb">
                        <div class="my_codeb-title"><h4>Example</h4><a href="../codelab2741.php" target="_blank" class="try-btn" title="Try this code using online Editor">Try this code <span>&raquo;</span></a></div>
                        <textarea id="code2" >
...
<button type="button" class="btn btn-warning" data-toggle="popover" data-placement="left" title="Popover title" data-content="Popover on left.">Popover on left</button>
                ...
                <div class="example">
                    <div class="my_codeb">
                        <div class="my_codeb-title"><h4>Example</h4><a href="../codelabbe57.html" target="_blank" class="try-btn" title="Try this code using online Editor">Try this code <span>&raquo;</span></a></div>
                        <textarea id="code3" >
<script>
$(document).ready(function(){
    ...
    $(".pop-left").popover({ placement : 'left'});
                ...
                <div class="example">
                    <div class="my_codeb">
                        <div class="my_codeb-title"><h4>Example</h4><a href="../codelabe439.html" target="_blank" class="try-btn" title="Try this code using online Editor">Try this code <span>&raquo;</span></a></div>
                        <textarea id="code4" >
<a href="#" class="btn btn-primary btn-lg" data-toggle="popover" tabindex="0" data-trigger="focus" title="Popover title" data-content="Here's some amazing content.">Dismissible popover</a>
                ...
                <hr />
                <h2>Options</h2>
                <p>There are certain options which may be passed to <code>popover()</code> Bootstrap method to customize the functionality of the popover plugin.</p>
                <div class="shadow">
                	<table class="data">
                    	<thead>
                        	<tr>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>'right'</td>
                                <td>Sets the position of the popover &mdash; top | bottom | left | right | auto. When "auto" value is specified, it will dynamically reorient the popover.</td>
                            </tr>
                            <tr>
                            	<td>selector</td>
                                <td>string</td>
							...
							<tr>
								<td>template</td>
								<td>string</td>
								<td><p style="font-size: 12px;"><code>'&lt;div class="popover" role="tooltip"&gt;&lt;div class="arrow"&gt;&lt;/div&gt;&lt;h3 class="popover-header"&gt;&lt;/h3&gt;&lt;div class="popover-body"&gt;&lt;/div&gt;&lt;/div&gt;'</code></p></td>
								<td>
                            ...
                            <tr>
                                ...
                                <td>string | array</td>
                                <td>'flip'</td>
                                <td>Allow to specify which position Popper will use on fallback.</td>
                            </tr>
                            <tr>
                            	<td>boundary</td>
                                <td>string | element</td>
                                <td>'scrollParent'</td>
                                <td>Overflow constraint boundary of the popover. Accepts the values of <code>'viewport'</code>, <code>'window'</code>, <code>'scrollParent'</code>, or an HTMLElement reference (JavaScript only).</td>
                            </tr>
                            <tr>
                            	<td>sanitize</td>
                                <td>boolean</td>
                            ...
                            <tr>
                            	<td>whiteList</td>
                                <td>object</td>
                                <td><a rel="nofollow" href="https://getbootstrap.com/docs/4.3/getting-started/javascript/#sanitizer" target="_blank">value</a></td>
				...
				<p>However, JavaScript is the more preferable way for setting these options as it saves you from doing the repetitive work. See the popover's method <a href="#popover-options"><code>$().popover(options)</code></a> in the section below to know how to set the options for popovers using the JavaScript.</p>
                <hr />
                <h2>Methods</h2>
                ...
                <div class="example">
                    <div class="my_codeb">
                        <div class="my_codeb-title"><h4>Example</h4><a href="../codelabe4ad.html" target="_blank" class="try-btn" title="Try this code using online Editor">Try this code <span>&raquo;</span></a></div>
                        <textarea id="code5" >
...
$(document).ready(function(){
    $("#myPopovers a").popover({
        title: 'Default title value'
                ...
                <div class="example">
                    <div class="my_codeb">
                        <div class="my_codeb-title"><h4>Example</h4><a href="../codelabffdd.html" target="_blank" class="try-btn" title="Try this code using online Editor">Try this code <span>&raquo;</span></a></div>
                        <textarea id="code6" >
...
$(document).ready(function(){
    $('[data-toggle="popover"]').popover({
        trigger: 'hover'
                ...
                <div class="example">
                    <div class="my_codeb">
                        <div class="my_codeb-title"><h4>Example</h4><a href="../codelabb4a0.html" target="_blank" class="try-btn" title="Try this code using online Editor">Try this code <span>&raquo;</span></a></div>
                        <textarea id="code7" >
...
$(document).ready(function(){
    $("#myPopover").popover({
        ...
        html: true
                ...
                <div class="example">
                    <div class="my_codeb">
                        <div class="my_codeb-title"><h4>Example</h4><a href="../codelab3760.html" target="_blank" class="try-btn" title="Try this code using online Editor">Try this code <span>&raquo;</span></a></div>
                        <textarea id="code8">
...
$(document).ready(function(){
    ...
    $(".popover-large").popover({
        delay: {show: 0, hide: 2000}
                ...
                <div class="example">
                    <div class="my_codeb">
                        <div class="my_codeb-title"><h4>Example</h4><a href="../codelab1664.html" target="_blank" class="try-btn" title="Try this code using online Editor">Try this code <span>&raquo;</span></a></div>
                        <textarea id="code9">
...
$(document).ready(function(){
    ...
    $(document).on("click", ".popover-footer .btn" , function(){
        $(this).parents(".popover").popover('hide');
				...
				<p>The following example will insert the dynamically generated HTML code of the popover at the end of a <code>.rg3-w</code> element instead of the <a href="../info-html/ht_body-tag.php"><code>&lt;body&gt;</code></a> element.</p>
                <div class="example">
                    <div class="my_codeb">
                        <div class="my_codeb-title"><h4>Example</h4><a href="../codelabf9c2.html" target="_blank" class="try-btn" title="Try this code using online Editor">Try this code <span>&raquo;</span></a></div>
                        <textarea id="code10">
...
$(document).ready(function(){
    ...
    $("#myPopovers a").popover({container: '.rg3-w'}); 
                ...
                <div class="example">
                    <div class="my_codeb">
                        <div class="my_codeb-title"><h4>Example</h4><a href="../codelab2f00.html" target="_blank" class="try-btn" title="Try this code using online Editor">Try this code <span>&raquo;</span></a></div>
                        <textarea id="code11">
...
$(document).ready(function(){
    $(".destroy-popover").click(function(){
        $("#myPopover").popover('dispose');
                ...
                <h2>.popover('enable')</h2>
                <p>This method gives an element's popover the ability to be shown. Popovers are enabled by default.</p>
                <div class="example">
                    <div class="my_codeb">
                        <div class="my_codeb-title"><h4>Example</h4><a href="../codelab2f00.html" target="_blank" class="try-btn" title="Try this code using online Editor">Try this code <span>&raquo;</span></a></div>
                        <textarea id="code15">
...
$(document).ready(function(){
    $(".destroy-popover").click(function(){
        $("#myPopover").popover('dispose');
                ...
                <h2>.popover('disable')</h2>
                <p>This method removes the ability for an element's popover to be shown. The popover will only be able to be shown if it is re-enabled.</p>
                <div class="example">
                    <div class="my_codeb">
                        <div class="my_codeb-title"><h4>Example</h4><a href="../codelab2f00.html" target="_blank" class="try-btn" title="Try this code using online Editor">Try this code <span>&raquo;</span></a></div>
                        <textarea id="code16">
...
$(document).ready(function(){
    $(".disable-popover").click(function(){
        $("#myPopover").popover('disable');
                ...
                <h2>.popover('toggleEnabled')</h2>
                <p>This method toggles the ability for an element's popover to be shown or hidden.</p>
                <div class="example">
                    <div class="my_codeb">
                        <div class="my_codeb-title"><h4>Example</h4><a href="../codelab2f00.html" target="_blank" class="try-btn" title="Try this code using online Editor">Try this code <span>&raquo;</span></a></div>
                        <textarea id="code17">
...
$(document).ready(function(){
    $(".toggle-enabled-popover").click(function(){
        $("#myPopover").popover('toggleEnabled');
                ...
                <p>This method updates the position of an element's popover.</p>
                <div class="example">
                    <div class="my_codeb">
                        <div class="my_codeb-title"><h4>Example</h4><a href="../codelab2f00.html" target="_blank" class="try-btn" title="Try this code using online Editor">Try this code <span>&raquo;</span></a></div>
                        <textarea id="code18">
...
$(document).ready(function(){
    $(".update-popover").click(function(){
        $("#myPopover").popover('update');
                ...
                <div class="example">
                    <div class="my_codeb">
                        <div class="my_codeb-title"><h4>Example</h4><a href="../codelab8842.html" target="_blank" class="try-btn" title="Try this code using online Editor">Try this code <span>&raquo;</span></a></div>
                        <textarea id="code19">
