<!DOCTYPE html>
	<html lang="en">
	<head>
	<meta name="description" content="How to Create Carousel with Bootstrap 3">
	  <meta name="keywords" content="Bootstrap,Bootstrap3,Create Carousel with Bootstrap 3">
	  <meta name="author" content="webschooltoday.com">
    <title>How to Create Carousel with Bootstrap 3 - WebSchool Today</title>
    <?php include "../links.php" ?>
</head>
<body>
<div>
<div class="tital">How to Create Carousel with Bootstrap 3</div>    
...
<?php include "des_bootstap3.php" ?>
        <div class="rg3-sec_main">
            <div class="rg3-sec_u">
                ...
                <a href="bt_accordion.php" class="previous-page" title="Go to Previous Page"></a>
            	<a href="bt_typeahead.php" class="next-page" title="Go to Next Page"></a>
                ...
                <p>The carousel also known as slideshow or image slider is some of the best way of showcasing the huge amount of contents within a small space on the web pages. It is a dynamic presentation of contents where text and images are made visible or accessible to the user by cycling through several items. The following example will show you how to build a simple carousel like image rotator using the Bootstrap carousel plugin.</p>
                <div class="example">
                    <div class="my_codeb">
                        <div class="my_codeb-title"><h4>Example</h4><a href="../codelabbf9a.html" target="_blank" class="try-btn" title="Try this code using online Editor">Try this code <span>&raquo;</span></a><span class="box-size"><i title="Maximize"></i></span></div>
                        <textarea id="code1">
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <a class="carousel-control right" href="#myCarousel" data-slide="next">
        <span class="glyphicon glyphicon-chevron-right"></span>
                ...
                <p>Check out the snippets section for examples of some <a href="../snippets/gallery92a0.php?tag=carousel" target="_blank">beautifully designed Bootstrap carousels</a>.</p>
                ...
                <div class="example">
                    <div class="my_codeb">
                        <div class="my_codeb-title"><h4>Example</h4><a href="../codelabb640.html" target="_blank" class="try-btn" title="Try this code using online Editor">Try this code <span>&raquo;</span></a><span class="box-size"><i title="Maximize"></i></span></div>
                        <textarea id="code2">
    ...
    <a class="carousel-control right" href="#myCarousel" data-slide="next">
        <span class="glyphicon glyphicon-chevron-right"></span>
				...
				<ul>
					...
					<li>The slides are specified within the <code>.carousel-inner</code> (<i>line no-9</i>) and the content of each slide is defined within the <code>.item</code> element that can be text and images.</li>
                ...
                <p>Rest of the thing is self explanatory, such as the <code>.carousel</code> element specifies the Bootstrap carousel, the <code>.carousel-indicators</code> element indicates how many slides are there in the carousel and which slide is currently active, the <code>.carousel-caption</code> element used within the <code>.item</code> element defines the caption for that slide etc.</p>
				<div class="color-box">
					<div class="shadow">
						<div class="info-tab tip-icon" title="Useful Tips"><i></i></div>
						<div class="tip-box" style="background-color:#fad28c"
>
							<p><strong>Important:</strong> It is required to add the class <code>.active</code> to one of the slides (i.e. on the <code>.item</code> element). Otherwise, the carousel will not be visible.</p>
						</div>
					</div>
				</div>
				<div class="color-box">
...
>
							<p><strong>Read Carefully:</strong> The <code>.slide</code> class adds CSS slide transition animation to the carousel that makes the items slide when showing the new item. But it doesn't work in Internet Explorer 8 &amp; 9 due to lack of support of the necessary CSS3 properties.</p>
						</div>
					</div>
				</div>
                <hr />
                ...
                <div class="example">
                    <div class="my_codeb">
                        <div class="my_codeb-title"><h4>Example</h4><a href="../codelab12aa.html" target="_blank" class="try-btn" title="Try this code using online Editor">Try this code <span>&raquo;</span></a></div>
                        <textarea id="code3">
...
$(document).ready(function(){
     $("#myCarousel").carousel();
                ...
                <p>For setting the carousel options via data attributes, just append the option name to <code>data-</code>, like <code>data-interval="3000"</code>, <code>data-pause="hover"</code>, etc.</p>
				<div class="shadow">
                	<table class="data">
                    	<thead>
                        	<tr>
                        ...
                        <tbody>
                        	<tr>
                            	<td><a href="../codelabcb33.html" target="_blank">interval</a></td>
                                <td>number</td>
                                <td>5000</td>
                            ...
                            <tr>
                            	<td><a href="../codelab6108.html" target="_blank">pause</a></td>
				...
				<p>Data attributes provides an easy way for setting the carousel options, however JavaScript is the more preferable way as it prevents you from repetitive work. See the <code><a href="#carousel-options">.carousel(options)</a></code> method in the section below to know how to set the options for carousels using JavaScript.</p>
                <hr />
				<h2>Disable Auto Sliding in Bootstrap Carousel</h2>
				<p>By default Bootstrap carousel is started playing or sliding automatically when the page loads. However, you can turn off this auto sliding by either setting the carousel <code>interval</code> option via data attribute like <code>data-interval="false"</code> on the <code>.carousel</code> element, or via JavaScript using the <code><a href="#carousel-options">.carousel(options)</a></code>, as shown in the following example:</p>
                <div class="my_codeb-rg3-w space">
                    <div class="my_codeb">
                        <div class="my_codeb-title"><h4>Example</h4><a href="../codelab5b57.html" target="_blank" class="try-btn" title="Try this code using online Editor">Try this code <span>&raquo;</span></a></div>
                        <textarea id="code4">
...
$(document).ready(function(){
     $("#myCarousel").carousel({
         interval : false
                ...
                <div class="my_codeb-rg3-w space">
                    <div class="my_codeb">
                        <div class="my_codeb-title"><h4>Example</h4><a href="../codelab4443.html" target="_blank" class="try-btn" title="Try this code using online Editor">Try this code <span>&raquo;</span></a></div>
                        <textarea id="code5">
...
$(document).ready(function(){
    $(".next-slide").click(function(){
        $("#myCarousel").carousel('next');
                ...
                <div class="example">
                    <div class="my_codeb">
                        <div class="my_codeb-title"><h4>Example</h4><a href="../codelab5650.html" target="_blank" class="try-btn" title="Try this code using online Editor">Try this code <span>&raquo;</span></a></div>
                        <textarea id="code11">
