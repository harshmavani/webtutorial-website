<!DOCTYPE html>
	<html lang="en">
	<head>
    <meta name="description" content="Learn how to place Bootstrap icons inside text, links, buttons, navs, etc. Bootstrap comes with more than 260 Glyphicons which are available in font format." />
	  <meta name="keywords" content="Bootstrap,Bootstrap3,icones">
	  <meta name="author" content="webschooltoday.com">
    <title>How to Use Bootstrap 3 Icons - WebSchool Today</title>
...
<body>
<div>
<div class="tital">How to Use Bootstrap 3 Icons</div>    
        ...
        <div class="rg3-sec_main">
            <div class="rg3-sec_u">
               ...
               <a href="bt_navs.php" class="next-page" title="Go to Next Page"><i class="fa fa-arrow-right" aria-hidden="true"></i>
                ...
                <p class="summary">In this tutorial you will learn how to use Bootstrap font icons.</p>
                <h2>Icons by Glyphicons</h2>
                <p>Bootstrap 3.3.7 includes more than 260 Glyphicons. These icons are available in font format for better usability and scalability. Since these Glyphicons are font based, so you can create icons of any color just through applying the CSS <code><a href="../info-css/css-color-property.php">color</a></code> property on the specific element.</p>
                <div class="scroll-pane">
                	<div class="bootstrap3-icons clearfix">
                        <ul>
                            <li>
...
>
                        <p><strong>Important:</strong> Bootstrap icons are provided by <a href="http://glyphicons.com/" target="_blank" rel="nofollow">Glyphicons</a>. However you are free to use these icons in your project but as a courtesy you can consider to include a link back to Glyphicons whenever practical.</p>
                    </div>
                    </div>
                </div>
                <hr />
                <h2>How to Use Icons in Your Code</h2>
                <p>To use the Bootstrap icons you will require an <code><a href="../info-html/ht_span-tag.php">&lt;span&gt;</a></code> tag along with a base class <code>glyphicon</code> and an individual icon class <code>glyphicon-*</code>. The general syntax for using Bootstrap icons is:</p>
                <div class="green-box break">&lt;span class="glyphicon glyphicon-class-name"&gt;&lt;/span&gt;</div>
                <p>Where <code>glyphicon-class-name</code> is the name of the particular icon class (e.g. <code>glyphicon-search</code>, <code>glyphicon-user</code>, <code>glyphicon-star</code> etc.) defined in <code>bootstrap.css</code>.</p>
                <p>For example, to use search icon you can place the following code just about anywhere:</p>
                <div class="example">
                    <div class="my_codeb">
                        <div class="my_codeb-title"><h4>Example</h4><a href="../codelabaf12.html" target="_blank" class="try-btn" title="Try this code using online Editor">Try this code <span>&raquo;</span></a></div>
                        <textarea id="code1">
...
<button type="submit" class="btn btn-primary"><span class="glyphicon glyphicon-search"></span>
				...
				<p>Use the <a href="../twitter-bt_button-generator.html" target="_blank">Bootstrap button generator tool</a> to create buttons with different icons and styles in a second. In the next chapter you will see how to use these icons in <a href="bt_navs.php">Bootstrap nav components</a>.</p>
                <div class="color-box">
                    <div class="shadow">
                        <div class="info-tab note-icon" title="Important Notes"><i></i></div>
                        <div class="note-box" style="background-color:#ff8585"
>
                            <p><strong>Read Carefully:</strong> Remember to leave a space after the closing tag of icon element <br>(i.e. after <code>&lt;/span&gt;</code> tag) when using icons along with the strings of text such as inside buttons or navigation links, to ensure proper spacing.</p>
                        </div>
                    </div>
                </div>
